<?php 
	...
	$page_name = "รายงานสินค้า แยกตามลูกค้า";
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_product_by_customer&view="+view+"&"+view_report+"&customer="+customer+"&"+customer_rank );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?product_by_customer&view="+view+"&"+view_report+"&customer="+customer+"&"+customer_rank , type:"GET",cache:false,
