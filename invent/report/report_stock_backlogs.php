<?php 
	$page_menu = "report_stock_backlogs";
	$page_name = "รายงานสินค้า ค้างส่ง";
...
<div class='row'>
    ...
    <tr><td colspan='4' style='padding-top:10px;'><input type='radio' name='product' id='product1' value='0' checked='checked' /><label for='product1' style='padding-left:15px;'>ทั้งหมด</label></td></tr>
    <tr><td style='width:20%; padding-top:10px;'><input type='radio' name='product' id='product2' value='1'/><label for='product2' style='padding-left:15px; margin-right:10px;'>จาก</label></td>
          ...
          <td style='width:10%; text-align: center; padding-top:10px;'>ถึง</td><td style='width:35%; padding-right:10px; padding-top:10px;'><input type='hidden' name='product_to' id='product_to' />
		  <input type='text' class='form-control' id='txt_product_to' disabled /></td>
	 </tr>
     <tr>
   ...
   <table width='100%' style='border-right:0px'>
    ...
    <tr><td colspan='4' style='padding-top:10px;'><input type='radio' name='customer' id='customer1' value='0' checked='checked' /><label for='customer1' style='padding-left:15px;'>ทั้งหมด</label></td></tr>
    <tr><td style='width:20%; padding-top:10px;'><input type='radio' name='customer' id='customer2' value='1'/><label for='customer2' style='padding-left:15px; margin-right:10px;'>จาก</label></td>
    	  <td style='width:35%; padding-top:10px;'><input type='hidden' name='customer_from' id='customer_from' />
          ...
          <td style='width:35%; padding-right:10px; padding-top:10px;'><input type='hidden' name='customer_to' id='customer_to' />
		  <input type='text' id='txt_customer_to' class='form-control input-sm' required='required' disabled='disabled' /></td>
     </tr>
     <tr>
     		<td style='width:20%; padding-top:10px;'><input type='radio' name='customer' id='customer3' value='2'/><label for='customer3' style='padding-left:15px;'>เฉพาะ</label></td>
            <td colspan ='3' style='padding-right:10px; padding-top:10px;'><input type='text'  id='txt_customer_selected' class='form-control input-sm' required='required' disabled='disabled' /></td>
    ...
    <tr><td style='width:25%; padding-top:10px;'><input type='radio' name='view' id='view_in' value='1' checked='checked' /><label for='view_in' style='padding-left:15px;'>แสดงเป็น</label></td>
    	  <td colspan='3' style='padding-left:10px; padding-top:10px;'><select name='view_selected' id='view_selected' class='form-control' >"; get_view_list($view); echo"</select></td>	
    </tr>
	<tr><td style='width:25%; padding-top:10px;'><input type='radio' name='view' id='view_rank' value='2' /><label for='view_rank' style='padding-left:15px;'>ระหว่าง</label></td>
    	  <td style='width:32%; padding-left:10px; padding-top:10px;'><input type='text' name='from_date' id='from_date' class='form-control' disabled /></td>	
		  <td style='width:10%; text-align:center; padding-top:10px;'>ถึง</td><td style='width:33%; padding-left:10px; padding-top:10px;'><input type='text' name='to_date' id='to_date' class='form-control' disabled /></td>
    </tr>
    </table>
    </div>
	 </form>
...
?>   
<hr style='border-color:#CCC; margin-top: 15px; margin-bottom:15px;' /><input type='hidden' id='view' value='1' /><input type='hidden' id='customer' value='0' /><input type='hidden' id='product' value='0' />
<div class='row'>
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_stock_back_log&view="+view+"&"+view_report+"&customer="+customer+"&"+customer_rank+"&product="+product+"&"+product_rank );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?stock_back_log&view="+view+"&"+view_report+"&customer="+customer+"&"+customer_rank+"&product="+product+"&"+product_rank , type:"GET",cache:false,
...
function switch_graph(){
	...
	if(i ==1){
		$("#i").val(2);
		$("#switch").html("แสดงตามออร์เดอร์");
		$("#product_row").css("display","");
		$("#order_row").css("display","none");
	}else if(i ==2){
		$("#i").val(1);
		$("#switch").html("แสดงตามรายการสินค้า");
		$("#order_row").css("display","");
