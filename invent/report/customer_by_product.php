<?php 
	...
	$page_name = "รายงานลูกค้า แยกตามสินค้า";
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_customer_by_product&view="+view+"&"+view_report+"&product="+product+"&"+product_rank );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?customer_by_product&view="+view+"&"+view_report+"&product="+product+"&"+product_rank , type:"GET",cache:false,
