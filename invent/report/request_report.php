<?php
	...
	$page_name = "รายงานการร้องขอสินค้า";
	$id_profile = $_COOKIE['profile_id'];
	?>
<div class="container">
<!-- page place holder --><form name='report_form' id='report_form' action='index.php?content=request_report&report=y' method='post'>
<div class="row">
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_request_report&view="+view+"&"+view_report+"&product="+product+"&"+product_rank );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?request_report&view="+view+"&"+view_report+"&product="+product+"&"+product_rank , type:"GET",cache:false,
