<?php
	$page_name = "รายละเอียดการขาย แยกตามพนักงานขาย";
...
<div class="row">
	<div class="col-sm-8"><h3><span class="glyphicon glyphicon-eye-open"></span>&nbsp;<?php echo $page_name; ?></h3></div>
    <div class="col-sm-4">
...
<div class='row'>
    ...
    <tr><td colspan='4' style='text-align:center; border-bottom:1px solid #CCC; padding:10px;'><h4 style='margin:0px;'>พนักงานขาย</h4></td></tr>
    <tr><td style='width:20%; padding-top:10px;'><input type='radio' name='sale' id='sale1' value='0' checked='checked' /><label for='sale1' style='padding-left:15px;'>ทั้งหมด</label></td><td colspan='3' style='padding-right:10px;'></td></tr>
    <tr><td style='width:20%; padding-top:10px;'><input type='radio' name='sale' id='sale2' value='1'/><label for='sale2' style='padding-left:15px; margin-right:10px;'>ตั้งแต่ :</label></td>
    	  <td style='width:35%; padding-top:10px;'><select id='sale_from' name='sale_from' class='form-control' disabled>"; saleList(); echo "</select></td>"; 
		  
         echo" <td style='width:10%; padding-left:10px; padding-top:10px;'>ถึง :</td>
          <td style='width:35%; padding-right:10px; padding-top:10px;'><select id='sale_to' name='sale_to' class='form-control' disabled>"; saleList(); echo "</select></td>";
     echo "</tr>
     <tr>
            ...
            <td colspan ='3' style='width:30%; padding-right:10px; padding-top:10px;'><select id='sale_selected' name='sale_selected' class='form-control' disabled >"; saleList(); echo" </select></td>";
echo"     </tr>
</table>
	</div>
    <div class='col-lg-6'>
...
?>   
<hr style='border-color:#CCC; margin-top: 15px; margin-bottom:15px;' /><input type='hidden' id='view' value='1' /><input type='hidden' id='sale' value='0' />
<div class='row'>
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_sale_amount_detail&view="+view+"&"+view_report+"&sale="+sale+"&"+sale_rank );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?sale_amount_detail&view="+view+"&"+view_report+"&sale="+sale+"&"+sale_rank , type:"GET",cache:false,
