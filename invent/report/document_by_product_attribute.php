<?php 
	$page_name = "รายงานเอกสาร แยกตามรายการสินค้า";
	$id_profile = $_COOKIE['profile_id'];
	?>
<div class="container">
<!-- page place holder --><form name='report_form' id='report_form' action='index.php?content=document_by_product_attribute&report=y' method='post'>
<div class="row">
    ...
    <div class="col-sm-6">
	   ...
	   if(!isset($_GET['report'])){
			...
			";
				...
				echo"<li><a href='index.php?content=document_by_product_attribute' style='text-align:center; background-color:transparent;'><button type='button' class='btn btn-link'><span class='glyphicon glyphicon-arrow-left' style='color:#5cb85c; font-size:30px;'></span><br />กลับ</button></a></li>";}
				?>
                </ul>
                </div>
</div>
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_document_by_product_attribute&view="+view+"&"+view_report+"&product="+product+"&"+product_rank );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?document_by_product_attribute&view="+view+"&"+view_report+"&product="+product+"&"+product_rank , type:"GET",cache:false,
