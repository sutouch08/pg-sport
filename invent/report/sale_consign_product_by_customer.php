...
<?php 
	$page_name = "รายงานยอดฝากขายแยกตามลูกค้าแสดงรายการสินค้า";
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_sale_consign_product_by_customer&"+view_report+"&customer="+customer+"&"+customer_report );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?sale_consign_product_by_customer&"+view_report+"&customer="+customer+"&"+customer_report , type:"POST",cache:false,
