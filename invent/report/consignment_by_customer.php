...
<?php 
	$page_name = "รายงานบิลส่งของไปฝากขาย แยกตามลูกค้า เรียงตามเลขที่เอกสาร";
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_consignment_by_customer&"+view_report+"&customer="+customer+"&"+customer_report );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?consignment_by_customer&"+view_report+"&customer="+customer+"&"+customer_report , type:"POST",cache:false,
