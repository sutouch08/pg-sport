...
<div class="row">
  <div class="col-sm-12 padding-0">
    <table class="table table-striped border-1">
      <thead>
        <tr class="font-size-12 col-border-1">
          ...
          <th class="width-5 text-center">จำนวน</th>
          <th class="width-5 text-center">ส่วนลด</th>
          <th class="width-8 text-center">ยอดรวม</th>
    ...
    <?php  $id = $rs->id_order_detail; ?>
        <tr class="font-size-12 col-border-1" id="row-<?php echo $id; ?>">
          <td class="text-center"><?php echo $no; ?></td>
          <td><?php echo $rs->barcode; ?></td>
          <td><?php echo $rs->product_reference; ?> : <?php echo $rs->product_name; ?></td>
          <td class="text-right" id="price-<?php echo $id; ?>"><?php echo number($rs->product_price,2); ?></td>
          <td class="text-right" id="qty-<?php echo $id; ?>"><?php echo number($rs->product_qty); ?></td>
          ...
          <td class="text-center">
            <button type="button" class="btn btn-sm btn-warning" onclick="editRow('<?php echo $id; ?>')">
              <i class="fa fa-pencil"></i>
            </button>
            <button type="button" class="btn btn-sm btn-danger" onclick="deleteRow('<?php echo $id; ?>')">
...
<script id="row-template" type="text/x-handlebarsTemplatte">
<tr class="font-size-12 col-border-1" id="row-{{id}}">
  ...
  <td class="text-center">
    <button type="button" class="btn btn-sm btn-warning" onclick="editRow({{id}})">
      <i class="fa fa-pencil"></i>
    </button>
